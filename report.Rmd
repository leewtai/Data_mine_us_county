...
There are other places where they could improve the logic in their ML model. Right now, outliers are singled out to LA but it would be a useful step to identify outliers prior to running kmeans, remove them, and then cluster on the cleaned data.
